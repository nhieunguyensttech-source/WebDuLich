...
@section('title', 'Tours - Tin tức Du lịch - Thông tin Du lịch, Tin tức Du Lịch Việt Nam 2025')
@section('style')
@stop
@section('content')
    ...
    <section class="ftco-section ftco-no-pb">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="text-center compare-title" style="font-size: 50px; color: #000;">TRA CỨU TOUR DU LỊCH</h2>
