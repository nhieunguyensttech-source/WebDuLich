<div>
    <div style="background-color:#c5ffff;text-align: center;border-color: green; border-style: solid; border-width: 5px;">
        <h4 style="text-align: center">
            ...
            Thanh toán của quý khách đã được xác nhận thành công
        </h4>
    </div>
    
    <h2 style="color: green;">Phiếu xác nhận thanh toán <b style="border-color: green; border-style: solid;color:green">ĐÃ THANH TOÁN</b></h2>
    ...
    <div style="background-color:#c5ffff;margin-top:8px; padding: 15px; text-align: center;">
        <p><strong>VHDTravel (Đi Để Trở Về)</strong></p>
        <p>Cảm ơn quý khách đã tin tưởng và sử dụng dịch vụ của chúng tôi!</p>
        <p>Chúng tôi sẽ liên hệ với quý khách sớm nhất để xác nhận thông tin tour.</p>
    </div>
</div>
